...
test('A cell knows the rules if it\'s alive', (assert) => {
  ...
  assert.equal(b, true, 'A cell stays alive in harmony when there are 2 living neighbors');
  assert.equal(c, true, 'A cell stays alive in harmony when there are 3 living neighbors');
